...
object DeviceTypeOutputs : Table<Nothing>("device_type_outputs") {
...
@Serializable
class DeviceTypeOutput(val id: Int, val device_type_name: String, val output_device_type_name: String)
